<template>
    <div class="row">
        <div class="col-md-12">
            <div class="form-check-inline">
                <input type="radio" class="form-check-input" id="inlineradio1" name="permission_type"
                    v-model="permissionData.permission_type" value="basic">
                <label for="inlineradio1" class="form-check-label">Basic</label>
            </div>
            <div class="form-check-inline">
                <input type="radio" class="form-check-input" id="inlineradio2" name="permission_type"
                    v-model="permissionData.permission_type" value="crud">
    ...
    <div class="row" v-if="permissionData.permission_type == 'crud'">
        ...
        <div class="col-md-8 mt-4 pt-3">
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" id="inlinecheckbox1" name="crudSelected[]"
                    v-model="permissionData.crudSelected" value="create">
                <label for="inlinecheckbox1" class="form-check-label">Create</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" id="inlinecheckbox2" name="crudSelected[]"
                    v-model="permissionData.crudSelected" value="read">
                <label for="inlinecheckbox2" class="form-check-label">Read</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" id="inlinecheckbox3" name="crudSelected[]"
                    v-model="permissionData.crudSelected" value="update">
                <label for="inlinecheckbox3" class="form-check-label">Update</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" id="inlinecheckbox4" name="crudSelected[]"
                    v-model="permissionData.crudSelected" value="delete">
...
export default {
    ...
    methods: {
        ...
        crudDisplayName(item) {
            return this.permissionData.resource.substr(0,1).toUpperCase() + this.permissionData.resource.substr(1) + 
